            ...
            <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-success p-0">
                <div class="container-fluid d-flex flex-column p-0">
                    ...
                    <ul class="nav navbar-nav text-light" id="accordionSidebar">
                        ...
                        <li class="nav-item" role="presentation"><a class="nav-link active" href="profile.html"><i
                                class="fas fa-user" style="font-size: 35px;"></i><span
                                style="margin: 10px;">Profile</span></a>
                        </li>
                        <li class="nav-item" role="presentation"><a class="nav-link" href="table.html"><i
                                class="fas fa-table" style="font-size: 35px;"></i><span
                                style="margin: 10px;">Transactions</span></a></li>
                        <li class="nav-item" role="presentation"><a class="nav-link" href="login.html"><i
                                class="far fa-user-circle" style="font-size: 35px;"></i><span
                                style="margin: 10px;">Login</span></a></li>
                                            ...
                                            <div class="card-body">
                                                <form>
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="col">
                                                            <div class="form-group"><label><strong>Last
                                                                Name</strong></label><input class="form-control"
                                                                                            type="text"
                                                                                            placeholder="Doe"
                                                                                            name="last_name"></div>
                                            ...
                                            <div class="card-body">
                                                <form>
                                                    ...
                                                    <div class="form-row">
                                                        <div class="col">
                                                            <div class="form-group">
                                                                <label><strong>City</strong></label><input
                                                                    class="form-control" type="text"
                                                                    placeholder="Los Angeles" name="city"></div>
                                                        </div>
                                                        <div class="col">
                                                            <div class="form-group"><label
                                                            ><strong>Country</strong></label><input
